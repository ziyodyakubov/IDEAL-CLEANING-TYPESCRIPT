...
import { Service, OrderFormValues, OrderModalProps } from "../../../types/order";
...
const OrderModal: React.FC<OrderModalProps> = ({ open, handleClose, edit, fetchData }) => {
  const [services, setServices] = useState<Service[]>([]);
  const [error, setError] = useState<string | null>(null);
  const [params, setParams] = useState<string | any>({ limit: 5, page: 1 });

  const initialValues: OrderFormValues = {
    amount: edit ? edit.amount : 0,
    client_full_name: edit ? edit.client_name : "",
